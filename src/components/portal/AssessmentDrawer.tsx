...
const emptyState = (previous?: Assessment | null) => ({
  ...
  volley_pct: previous?.volley_pct ?? 50,
  forehand_pct: previous?.forehand_pct ?? 50,
  serve_pct: previous?.serve_pct ?? 50,
  smash_pct: previous?.smash_pct ?? 50,
  backhand_pct: previous?.backhand_pct ?? 50,
  lob_pct: previous?.lob_pct ?? 50,
  ...
  useEffect(() => {
    ...
    if (editing) {
      setForm({
        ...
        sport: editing.sport,
        volley_pct: editing.volley_pct,
        forehand_pct: editing.forehand_pct,
        serve_pct: editing.serve_pct,
        smash_pct: editing.smash_pct,
        backhand_pct: editing.backhand_pct,
        lob_pct: editing.lob_pct,
